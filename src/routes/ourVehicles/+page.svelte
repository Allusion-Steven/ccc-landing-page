<script lang="ts">
    ...
    async function fetchData() {
        ...
        try {
            ...
            const response = await fetch(`https://my.macroexotics.com/api/vehicles`);
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        {#if loading}
            <div class="flex flex-col items-center justify-center space-y-4 py-12">
                <div class="h-12 w-12 animate-spin rounded-full border-4 border-[#0bd3d3] border-t-transparent"></div>
                    ...
                    <div animate:flip={{duration: 300}}>
                        ...
                        >
                            <div class="aspect-[16/10] w-full overflow-hidden">
                                ...
                                <div class="absolute bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-black/90 to-black/0 p-4 text-white">
