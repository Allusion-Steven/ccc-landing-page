...
<div class="policy-container mx-auto max-w-[1000px]">
	<div class="policy">
		...
		<p class="text-slate-300">
			...
			means. This includes, for example, ﬁlling in our 'Contact Us' form on our Website or when you
			provide your information to us in order to receive our services. The information you give us
			may include: email address, name, mailing address, telephone number, company name, company
			address, credit card information, job title, account information, and any updates to
			information provided to us. Please note that we need certain types of information so that we
		...
		<p class="text-slate-300">
			...
			company to handle your Personal Information. More speciﬁcally, we collect, use and store your
		...
		<p class="text-slate-300">
			...
			a member of our group, including those that are listed in this Privacy Policy. Nevertheless,
			we may disclose your Personal Information for a variety of legitimate and legal purposes,
		...
		<p class="text-slate-300">
			...
			other technology are also used to monitor usage of the various features and services of our
			site, which over time gives us information to improve our site, and to advertise and market
			our products more eﬀectively. When you visit our websites, cookies will be placed on your
			computer or device to maximize your experience and to help us understand how we can improve
			our site. If you prefer not to receive cookies, you can set your browser to either reject all
			cookies, to allow "trusted" sites to set them, or to accept only those cookies from those
		...
		<p class="text-slate-300">
			...
			third-parties. If you choose to visit any of those sites, then their privacy policies would
			apply and you should read these carefully before you submit any Personal Information to these
