...
<div class="container mx-auto min-h-screen px-4 py-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="flex flex-col justify-between space-y-6">
            ...
            <div class="flex flex-col space-y-4">
                <button class="w-full rounded-lg bg-[#0bd3d3] px-6 py-3 font-semibold text-black transition-all duration-300 hover:bg-[#0bd3d3]/80">
                    Book Now
                </button>
                <a href="/contact" class="w-full text-center rounded-lg border border-[#0bd3d3] px-6 py-3 font-semibold text-[#0bd3d3] transition-all duration-300 hover:bg-[#0bd3d3]/10">
                    Contact Us
                </a>
            </div>
        </div>
    ...
    <h2 class="mt-20 text-3xl font-bold text-white uppercase">Description</h2>

    <!-- TODO: Need to add a description section here from the vehicle object -->
    <div class="mt-8 bg-white/5 p-6 rounded-lg shadow-md">
